...
%global pkg_name spatio_temporal_voxel_layer
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-spatio-temporal-voxel-layer
Version:        2.7.0
Release:        1%{?dist}
...
%changelog
* Wed Aug 05 2026 Steve Macenski <stevenmacenski@gmail.com> - 2.7.0-1
